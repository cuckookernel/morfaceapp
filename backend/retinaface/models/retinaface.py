...
class ClassHead(nn.Module):
    def __init__(self, inchannels=512, num_anchors=3):
        ...
        self.conv1x1 = nn.Conv2d(inchannels, self.num_anchors*2, kernel_size=(1, 1),
                                 stride=1, padding=0)
...
class BboxHead(nn.Module):
    def __init__(self, inchannels=512, num_anchors=3):
        ...
        self.conv1x1 = nn.Conv2d(inchannels, num_anchors*4, kernel_size=(1, 1),
                                 stride=1, padding=0)
...
class LandmarkHead(nn.Module):
    def __init__(self, inchannels=512, num_anchors=3):
        ...
        self.conv1x1 = nn.Conv2d(inchannels, num_anchors*10, kernel_size=(1, 1),
                                 stride=1, padding=0)
